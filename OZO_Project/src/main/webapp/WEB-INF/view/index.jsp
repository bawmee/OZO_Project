...
<style>
.floating { background-color:#f9f9f9; z-index: 7; border:4px solid #6495ED; position: fixed; right: 50%; top: 180px; margin-right: -615px; text-align:center; width:70px; border-radius: 8px; -webkit-border-radius: 8px; } 
.floating div:nth-child(1){ border:4px solid #6495ED; } 
.floating div:nth-child(2){ border:4px solid #6495ED; }
.floating div:nth-child(3){ border:4px solid #6495ED; }
            ...
            <div class="span12">
              ...
              <div class="nivo-caption" id="caption-1">
                <div>
                  ...
                  <a href="/OZO_Project/space/search?condition=type&keyword=공유주방" class="btn btn-theme">Read More</a>
                </div>
              </div>
              <!-- Slide #2 caption -->
              <div class="nivo-caption" id="caption-2">
                <div>
                  ...
                  <a href="/OZO_Project/space/search?condition=type&keyword=다목적홀" class="btn btn-theme">Read More</a>
                </div>
              </div>
              <!-- Slide #3 caption -->
              <div class="nivo-caption" id="caption-3">
                <div>
                  ...
                  <a href="/OZO_Project/space/search?condition=type&keyword=파티룸" class="btn btn-theme">Read More</a>
                </div>
              </div>
              <!-- Slide #4 caption -->
              <div class="nivo-caption" id="caption-4">
                <div>
                  ...
                  <a href="/OZO_Project/space/search?condition=type&keyword=코워킹스페이스" class="btn btn-theme">Read More</a>
                </div>
              </div>
              <!-- Slide #5 caption -->
              <div class="nivo-caption" id="caption-5">
                <div>
                  ...
                  <a href="/OZO_Project/space/search?condition=type&keyword=세미나" class="btn btn-theme">Read More</a>
                </div>
              </div>
            </div>
          </div>
