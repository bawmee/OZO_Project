                           ...
                           if (clickS == null){                               
                              ...
                              while(tmp.val() != clickE.val()){ 
                                 ...
                                 if (tmp.attr('class').indexOf('andae') != -1){
                                     ...
                                     clickS.prevAll().unbind("click");
                                     clickS.prevAll().css('background-color','#e9e9e9');
               ...
               <div class="span6 form-group">
                  ...
                  <div style="margin-left:25px">
                   ...
                   <div class="span12 form-group">
                      <p class="text-center">
                          <button class="btn btn-inverse btn-rounded margintop10" type="button" data-toggle="modal" data-target="#calcModal">Register Reserve</button>
                     </p>
                   </div>
